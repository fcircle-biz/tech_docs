...
(function() {
    ...
    // ========================================
    const steps = [
        { number: 1, title: 'ステップ1', subtitle: '環境構築', file: 'tutorial-step-01.html' },
        { number: 2, title: 'ステップ2', subtitle: 'プロジェクト作成', file: 'tutorial-step-02.html' },
        { number: 3, title: 'ステップ3', subtitle: 'データベース設計', file: 'tutorial-step-03.html' },
        { number: 4, title: 'ステップ4', subtitle: 'モデル実装', file: 'tutorial-step-04.html' },
        { number: 5, title: 'ステップ5', subtitle: 'ビュー実装', file: 'tutorial-step-05.html' },
        { number: 6, title: 'ステップ6', subtitle: 'テンプレート作成', file: 'tutorial-step-06.html' },
        { number: 7, title: 'ステップ7', subtitle: 'フォーム処理', file: 'tutorial-step-07.html' },
        { number: 8, title: 'ステップ8', subtitle: 'セキュリティ対策', file: 'tutorial-step-08.html' },
        { number: 9, title: 'ステップ9', subtitle: 'テスト実装', file: 'tutorial-step-09.html' },
        { number: 10, title: 'ステップ10', subtitle: 'デプロイ', file: 'tutorial-step-10.html' }
    ];
