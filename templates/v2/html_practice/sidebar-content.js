/**
 * 練習問題サイドバーコンテンツ生成JavaScript
 * 各回のHTMLから共通のサイドバー部分を動的に生成
 *
 * 【使い方】
 * 1. このファイルを各技術フォルダにコピー
 * 2. chapters配列を実際の回構成に合わせて編集
...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1回: 基本文法の確認', file: 'practice-01.html' },
        { number: 2, title: '第2回: データ型と演算', file: 'practice-02.html' },
        { number: 3, title: '第3回: 制御構文', file: 'practice-03.html' },
        { number: 4, title: '第4回: 関数の基礎', file: 'practice-04.html' },
        { number: 5, title: '第5回: リスト・配列', file: 'practice-05.html' },
        { number: 6, title: '第6回: 辞書・オブジェクト', file: 'practice-06.html' },
        { number: 7, title: '第7回: ファイル操作', file: 'practice-07.html' },
        { number: 8, title: '第8回: エラー処理', file: 'practice-08.html' },
        { number: 9, title: '第9回: クラスとオブジェクト', file: 'practice-09.html' },
        { number: 10, title: '第10回: 総合問題', file: 'practice-10.html' }
    ];
            ...
            <div class="p-4">
                ...
                <div class="mb-6 p-4 bg-primary-50 rounded-xl">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-sm text-primary-600">${currentChapterNumber}/${chapters.length}回</span>
                    </div>
                ...
                <nav>
                    <h2 class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3 px-2">
                        <i class="fas fa-list-check mr-1"></i>練習問題
                    </h2>
                    <ul class="space-y-1">
${chapterListHTML}
                    </ul>
