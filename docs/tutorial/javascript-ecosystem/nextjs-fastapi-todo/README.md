...
|----------|------|----------|
| Step 1 | 開発環境の準備 | 2時間 |
| Step 2 | DockerでPostgreSQLデータベースを構築 | 1.5時間 |
| Step 3 | FastAPIバックエンドの基礎 | 2時間 |
| Step 4 | タスク一覧表示機能（バックエンド） | 1.5時間 |
| Step 5 | タスク作成・更新・削除機能（バックエンド） | 2時間 |
| Step 6 | Next.jsフロントエンドの基礎 | 2時間 |
| Step 7 | CORS設定とタスク一覧表示 | 1.5時間 |
| Step 8 | タスク追加機能 | 1時間 |
| Step 9 | タスクの完了切替・削除機能 | 1時間 |
| Step 10 | フィルター機能の実装 | 45分 |
| Step 11 | アプリの仕上げとまとめ | 1.5時間 |
| **合計** | | **約17時間** |
