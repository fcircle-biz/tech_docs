...
(function() {
    ...
    // ========================================
    // 章の定義データ（DDD入門ガイド - 全16章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: DDDとは何か', file: 'ddd-learning-material-01.html' },
        { number: 2, title: '第2章: ユビキタス言語', file: 'ddd-learning-material-02.html' },
        { number: 3, title: '第3章: ドメインモデルの基礎', file: 'ddd-learning-material-03.html' },
        { number: 4, title: '第4章: エンティティ', file: 'ddd-learning-material-04.html' },
        { number: 5, title: '第5章: 値オブジェクト', file: 'ddd-learning-material-05.html' },
        { number: 6, title: '第6章: 集約', file: 'ddd-learning-material-06.html' },
        { number: 7, title: '第7章: リポジトリ', file: 'ddd-learning-material-07.html' },
        { number: 8, title: '第8章: ドメインサービス', file: 'ddd-learning-material-08.html' },
        { number: 9, title: '第9章: ファクトリ', file: 'ddd-learning-material-09.html' },
        { number: 10, title: '第10章: 境界づけられたコンテキスト', file: 'ddd-learning-material-10.html' },
        { number: 11, title: '第11章: コンテキストマップ', file: 'ddd-learning-material-11.html' },
        { number: 12, title: '第12章: レイヤードアーキテクチャ', file: 'ddd-learning-material-12.html' },
        { number: 13, title: '第13章: ドメインイベント', file: 'ddd-learning-material-13.html' },
        { number: 14, title: '第14章: 実践演習', file: 'ddd-learning-material-14.html' },
        { number: 15, title: '第15章: 既存システムへのDDD適用', file: 'ddd-learning-material-15.html' },
        { number: 16, title: '第16章: DDDと他の設計パターン', file: 'ddd-learning-material-16.html' }
    ];
