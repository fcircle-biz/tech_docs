...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: そもそも「システム開発」とは何か？', file: 'waterfall-development-learning-material-01.html' },
        { number: 2, title: '第2章: ウォーターフォール開発とは？〜水が流れるように進む開発〜', file: 'waterfall-development-learning-material-02.html' },
        { number: 3, title: '第3章: 要件定義〜「何を作るか」を決める〜', file: 'waterfall-development-learning-material-03.html' },
        { number: 4, title: '第4章: 基本設計〜「どんな形にするか」を決める〜', file: 'waterfall-development-learning-material-04.html' },
        { number: 5, title: '第5章: 詳細設計〜「どうやって動かすか」を決める〜', file: 'waterfall-development-learning-material-05.html' },
        { number: 6, title: '第6章: 実装（プログラミング）〜設計図通りに作る〜', file: 'waterfall-development-learning-material-06.html' },
        { number: 7, title: '第7章: テスト〜ちゃんと動くか確認する〜', file: 'waterfall-development-learning-material-07.html' },
        { number: 8, title: '第8章: リリースと運用〜完成品を届けて使ってもらう〜', file: 'waterfall-development-learning-material-08.html' },
        { number: 9, title: '第9章: ウォーターフォール開発のメリットとデメリット', file: 'waterfall-development-learning-material-09.html' },
        { number: 10, title: '第10章: プロジェクト管理の基本〜チームで開発を成功させる〜', file: 'waterfall-development-learning-material-10.html' },
        { number: 11, title: '第11章: ドキュメント（文書）の重要性', file: 'waterfall-development-learning-material-11.html' },
        { number: 12, title: '第12章: ウォーターフォール開発の実践例〜架空のプロジェクトで体験〜', file: 'waterfall-development-learning-material-12.html' }
    ];
