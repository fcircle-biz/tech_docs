...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: ソフトウェアテストとは', file: 'software-testing-learning-material-01.html' },
        { number: 2, title: '第2章: テストの基本原則', file: 'software-testing-learning-material-02.html' },
        { number: 3, title: '第3章: テストプロセスの全体像', file: 'software-testing-learning-material-03.html' },
        { number: 4, title: '第4章: テストレベル - 単体・結合・システムテスト', file: 'software-testing-learning-material-04.html' },
        { number: 5, title: '第5章: テストタイプ - 機能・非機能・変更テスト', file: 'software-testing-learning-material-05.html' },
        { number: 6, title: '第6章: ブラックボックステスト技法', file: 'software-testing-learning-material-06.html' },
        { number: 7, title: '第7章: ホワイトボックステスト技法', file: 'software-testing-learning-material-07.html' },
        { number: 8, title: '第8章: 経験ベースのテスト技法', file: 'software-testing-learning-material-08.html' },
        { number: 9, title: '第9章: テストドキュメント - テスト計画書・テストケース', file: 'software-testing-learning-material-09.html' },
        { number: 10, title: '第10章: バグ報告と不具合管理', file: 'software-testing-learning-material-10.html' },
        { number: 11, title: '第11章: テスト自動化の基礎', file: 'software-testing-learning-material-11.html' },
        { number: 12, title: '第12章: アジャイル開発におけるテスト', file: 'software-testing-learning-material-12.html' }
    ];
