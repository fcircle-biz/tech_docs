...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: アルゴリズムとは', file: 'algorithm-basics-learning-material-01.html' },
        { number: 2, title: '第2章: 順次・分岐・繰り返し', file: 'algorithm-basics-learning-material-02.html' },
        { number: 3, title: '第3章: フローチャート基礎', file: 'algorithm-basics-learning-material-03.html' },
        { number: 4, title: '第4章: 演習① 基本フローチャート', file: 'algorithm-basics-learning-material-04.html' },
        { number: 5, title: '第5章: 線形探索を体験する', file: 'algorithm-basics-learning-material-05.html' },
        { number: 6, title: '第6章: 演習② 総合課題', file: 'algorithm-basics-learning-material-06.html' },
        { number: 7, title: '第7章: 振り返り・まとめ', file: 'algorithm-basics-learning-material-07.html' },
    ];
