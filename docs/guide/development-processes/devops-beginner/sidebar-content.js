...
(function() {
    ...
    // ========================================
    // 章の定義データ（DevOps入門 - 全12章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: ITとソフトウェアの世界へようこそ', file: 'devops-beginner-learning-material-01.html' },
        { number: 2, title: '第2章: DevOpsとは何か', file: 'devops-beginner-learning-material-02.html' },
        { number: 3, title: '第3章: コンピュータの仕組み', file: 'devops-beginner-learning-material-03.html' },
        { number: 4, title: '第4章: コマンドラインの基礎', file: 'devops-beginner-learning-material-04.html' },
        { number: 5, title: '第5章: ファイルのバージョン管理', file: 'devops-beginner-learning-material-05.html' },
        { number: 6, title: '第6章: インターネットの仕組み', file: 'devops-beginner-learning-material-06.html' },
        { number: 7, title: '第7章: サーバーとは何か', file: 'devops-beginner-learning-material-07.html' },
        { number: 8, title: '第8章: ソフトウェア開発の流れ', file: 'devops-beginner-learning-material-08.html' },
        { number: 9, title: '第9章: 自動化の考え方', file: 'devops-beginner-learning-material-09.html' },
        { number: 10, title: '第10章: コンテナ技術入門', file: 'devops-beginner-learning-material-10.html' },
        { number: 11, title: '第11章: クラウドサービス入門', file: 'devops-beginner-learning-material-11.html' },
        { number: 12, title: '第12章: DevOpsエンジニアへの道', file: 'devops-beginner-learning-material-12.html' }
    ];
