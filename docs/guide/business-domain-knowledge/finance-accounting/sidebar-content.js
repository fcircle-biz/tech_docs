...
(function() {
    ...
    // ========================================
    // 章の定義データ（財務・管理会計入門 全10章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: 会計の基礎概念と役割', file: 'finance-accounting-learning-material-01.html' },
        { number: 2, title: '第2章: 簿記の基本と仕訳の実践', file: 'finance-accounting-learning-material-02.html' },
        { number: 3, title: '第3章: 貸借対照表（B/S）の構造と読み方', file: 'finance-accounting-learning-material-03.html' },
        { number: 4, title: '第4章: 損益計算書（P/L）の構造と読み方', file: 'finance-accounting-learning-material-04.html' },
        { number: 5, title: '第5章: キャッシュ・フロー計算書（C/F）の理解', file: 'finance-accounting-learning-material-05.html' },
        { number: 6, title: '第6章: 決算処理と会計サイクル', file: 'finance-accounting-learning-material-06.html' },
        { number: 7, title: '第7章: 財務分析の基本（収益性・安全性）', file: 'finance-accounting-learning-material-07.html' },
        { number: 8, title: '第8章: 財務分析の応用（効率性・成長性）', file: 'finance-accounting-learning-material-08.html' },
        { number: 9, title: '第9章: 管理会計の基礎（原価計算と予算管理）', file: 'finance-accounting-learning-material-09.html' },
        { number: 10, title: '第10章: ビジネスでの会計知識活用', file: 'finance-accounting-learning-material-10.html' }
    ];
