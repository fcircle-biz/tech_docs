...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: ビジネス文書とは何か', file: 'business-docs-intro-learning-material-01.html' },
        { number: 2, title: '第2章: 敬語と言葉遣いの基本', file: 'business-docs-intro-learning-material-02.html' },
        { number: 3, title: '第3章: ビジネス文書の基本構造', file: 'business-docs-intro-learning-material-03.html' },
        { number: 4, title: '第4章: 社内連絡・報告の書き方', file: 'business-docs-intro-learning-material-04.html' },
        { number: 5, title: '第5章: ビジネスメールの基本', file: 'business-docs-intro-learning-material-05.html' },
        { number: 6, title: '第6章: ビジネスメールの実践', file: 'business-docs-intro-learning-material-06.html' },
        { number: 7, title: '第7章: 報告書の作成', file: 'business-docs-intro-learning-material-07.html' },
        { number: 8, title: '第8章: 議事録の作成', file: 'business-docs-intro-learning-material-08.html' },
        { number: 9, title: '第9章: 提案書・企画書の基礎', file: 'business-docs-intro-learning-material-09.html' },
        { number: 10, title: '第10章: 実践演習と総まとめ', file: 'business-docs-intro-learning-material-10.html' }
    ];
