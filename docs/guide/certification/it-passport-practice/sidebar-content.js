...
(function() {
    ...
    // ========================================
    // 章の定義データ（ITパスポート試験 練習問題集）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: コンピュータ', file: 'it-passport-practice-01.html' },
        { number: 2, title: '第2章: データベース', file: 'it-passport-practice-02.html' },
        { number: 3, title: '第3章: ネットワーク', file: 'it-passport-practice-03.html' },
        { number: 4, title: '第4章: セキュリティ', file: 'it-passport-practice-04.html' },
        { number: 5, title: '第5章: システムの導入', file: 'it-passport-practice-05.html' },
        { number: 6, title: '第6章: システム開発', file: 'it-passport-practice-06.html' },
        { number: 7, title: '第7章: プロジェクトマネジメント', file: 'it-passport-practice-07.html' },
        { number: 8, title: '第8章: 企業活動', file: 'it-passport-practice-08.html' },
        { number: 9, title: '第9章: ITの活用', file: 'it-passport-practice-09.html' },
        { number: 10, title: '第10章: 法務と財務', file: 'it-passport-practice-10.html' }
    ];
