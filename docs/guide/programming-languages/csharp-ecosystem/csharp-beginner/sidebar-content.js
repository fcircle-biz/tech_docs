...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: プログラミングとC#について知ろう', file: 'csharp-beginner-learning-material-01.html' },
        { number: 2, title: '第2章: Visual Studioをインストールしよう', file: 'csharp-beginner-learning-material-02.html' },
        { number: 3, title: '第3章: Visual Studioの基本操作を覚えよう', file: 'csharp-beginner-learning-material-03.html' },
        { number: 4, title: '第4章: はじめてのプログラムを作ろう', file: 'csharp-beginner-learning-material-04.html' },
        { number: 5, title: '第5章: 変数とデータ型を理解しよう', file: 'csharp-beginner-learning-material-05.html' },
        { number: 6, title: '第6章: 演算子と計算をしてみよう', file: 'csharp-beginner-learning-material-06.html' },
        { number: 7, title: '第7章: 条件分岐で処理を分けよう', file: 'csharp-beginner-learning-material-07.html' },
        { number: 8, title: '第8章: 繰り返し処理をマスターしよう', file: 'csharp-beginner-learning-material-08.html' },
        { number: 9, title: '第9章: 配列とリストでデータを管理しよう', file: 'csharp-beginner-learning-material-09.html' },
        { number: 10, title: '第10章: メソッドで処理をまとめよう', file: 'csharp-beginner-learning-material-10.html' },
        { number: 11, title: '第11章: クラスとオブジェクト指向の基礎を学ぼう', file: 'csharp-beginner-learning-material-11.html' },
        { number: 12, title: '第12章: 例外処理とエラーへの対応を学ぼう', file: 'csharp-beginner-learning-material-12.html' },
        { number: 13, title: '第13章: 総合演習：シンプルな家計簿アプリを作ろう', file: 'csharp-beginner-learning-material-13.html' }
    ];
