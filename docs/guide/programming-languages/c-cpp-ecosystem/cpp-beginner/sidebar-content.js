...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: C/C++の世界へようこそ', file: 'cpp-beginner-learning-material-01.html' },
        { number: 2, title: '第2章: 最初のプログラム - Hello World', file: 'cpp-beginner-learning-material-02.html' },
        { number: 3, title: '第3章: 変数と基本データ型', file: 'cpp-beginner-learning-material-03.html' },
        { number: 4, title: '第4章: 演算子と式', file: 'cpp-beginner-learning-material-04.html' },
        { number: 5, title: '第5章: 条件分岐 - プログラムに判断させる', file: 'cpp-beginner-learning-material-05.html' },
        { number: 6, title: '第6章: 繰り返し処理 - ループを使いこなす', file: 'cpp-beginner-learning-material-06.html' },
        { number: 7, title: '第7章: 配列と文字列（C言語）', file: 'cpp-beginner-learning-material-07.html' },
        { number: 8, title: '第8章: 関数の基本', file: 'cpp-beginner-learning-material-08.html' },
        { number: 9, title: '第9章: ポインタの基礎', file: 'cpp-beginner-learning-material-09.html' },
        { number: 10, title: '第10章: 構造体とメモリ管理', file: 'cpp-beginner-learning-material-10.html' },
        { number: 11, title: '第11章: C++への移行 - モダンな機能を使おう', file: 'cpp-beginner-learning-material-11.html' },
        { number: 12, title: '第12章: クラスとオブジェクト指向の基礎', file: 'cpp-beginner-learning-material-12.html' },
        { number: 13, title: '第13章: C++の便利機能 - STL入門', file: 'cpp-beginner-learning-material-13.html' },
        { number: 14, title: '第14章: ファイル入出力', file: 'cpp-beginner-learning-material-14.html' },
        { number: 15, title: '第15章: 実践プログラミング - 総合演習', file: 'cpp-beginner-learning-material-15.html' }
    ];
