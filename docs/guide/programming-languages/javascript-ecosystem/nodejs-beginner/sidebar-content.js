...
(function() {
    ...
    // ========================================
    // 章の定義データ（Node.js入門ガイド）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Node.jsとは何か', file: 'nodejs-beginner-learning-material-01.html' },
        { number: 2, title: '第2章: Node.js環境のセットアップ', file: 'nodejs-beginner-learning-material-02.html' },
        { number: 3, title: '第3章: はじめてのNode.jsプログラム', file: 'nodejs-beginner-learning-material-03.html' },
        { number: 4, title: '第4章: モジュールシステムを理解しよう', file: 'nodejs-beginner-learning-material-04.html' },
        { number: 5, title: '第5章: 組み込みモジュールを活用しよう', file: 'nodejs-beginner-learning-material-05.html' },
        { number: 6, title: '第6章: npmとパッケージ管理', file: 'nodejs-beginner-learning-material-06.html' },
        { number: 7, title: '第7章: 非同期処理をマスターしよう', file: 'nodejs-beginner-learning-material-07.html' },
        { number: 8, title: '第8章: ファイル操作をマスターしよう', file: 'nodejs-beginner-learning-material-08.html' },
        { number: 9, title: '第9章: HTTPサーバーを作ってみよう', file: 'nodejs-beginner-learning-material-09.html' },
        { number: 10, title: '第10章: Expressフレームワーク入門', file: 'nodejs-beginner-learning-material-10.html' },
        { number: 11, title: '第11章: REST APIサーバーを構築しよう', file: 'nodejs-beginner-learning-material-11.html' },
        { number: 12, title: '第12章: タスク管理APIを作ろう', file: 'nodejs-beginner-learning-material-12.html' }
    ];
