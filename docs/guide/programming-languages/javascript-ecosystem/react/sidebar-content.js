...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: React入門 - なぜReactを学ぶのか', file: 'react-learning-material-01.html' },
        { number: 2, title: '第2章: JSXとTypeScriptでのReact開発', file: 'react-learning-material-02.html' },
        { number: 3, title: '第3章: 関数コンポーネントとProps - データフロー設計', file: 'react-learning-material-03.html' },
        { number: 4, title: '第4章: useState - 状態管理の基礎', file: 'react-learning-material-04.html' },
        { number: 5, title: '第5章: useEffect - 副作用とライフサイクル', file: 'react-learning-material-05.html' },
        { number: 6, title: '第6章: イベント処理とフォーム - インタラクティブUI', file: 'react-learning-material-06.html' },
        { number: 7, title: '第7章: useReducer と Context API - 高度な状態管理', file: 'react-learning-material-07.html' },
        { number: 8, title: '第8章: カスタムフック - ロジックの再利用', file: 'react-learning-material-08.html' },
        { number: 9, title: '第9章: パフォーマンス最適化 - メモ化とコード分割', file: 'react-learning-material-09.html' },
        { number: 10, title: '第10章: React Router - ルーティングとナビゲーション', file: 'react-learning-material-10.html' },
        { number: 11, title: '第11章: データフェッチングと状態同期', file: 'react-learning-material-11.html' },
        { number: 12, title: '第12章: テストとデプロイメント', file: 'react-learning-material-12.html' }
    ];
