...
| 章 | 内容 | 目安時間 |
|----------|------|----------|
| 第1章 | プログラミングとJavaScriptを知ろう | 45分 |
| 第2章 | 開発環境を準備しよう | 45分 |
| 第3章 | はじめてのプログラムを書こう | 45分 |
| 第4章 | 変数で情報を記憶しよう | 1時間 |
| 第5章 | 条件によって処理を変えよう（if文） | 1時間 |
| 第6章 | 同じ処理を繰り返そう（for文・while文） | 1時間 |
| 第7章 | 処理をまとめよう（関数の基礎） | 1時間 |
| 第8章 | 複数のデータを扱おう（配列とオブジェクト） | 1時間30分 |
| 第9章 | Webページを動かそう（DOM操作の基礎） | 1時間30分 |
| 第10章 | ユーザーの操作に反応しよう（イベント処理） | 1時間30分 |
| 第11章 | 時間差で処理しよう（非同期処理入門） | 1時間30分 |
| 第12章 | ToDoアプリを作ろう（総合演習） | 3時間 |
| **合計** | | **約15時間** |
