...
(function() {
    ...
    // ========================================
    // JavaScript学習ガイド - 章の定義データ
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: プログラミングとJavaScriptを知ろう', file: 'javascript-learning-material-01.html' },
        { number: 2, title: '第2章: 開発環境を準備しよう', file: 'javascript-learning-material-02.html' },
        { number: 3, title: '第3章: はじめてのプログラムを書こう', file: 'javascript-learning-material-03.html' },
        { number: 4, title: '第4章: 変数で情報を記憶しよう', file: 'javascript-learning-material-04.html' },
        { number: 5, title: '第5章: 条件によって処理を変えよう（if文）', file: 'javascript-learning-material-05.html' },
        { number: 6, title: '第6章: 同じ処理を繰り返そう（for文・while文）', file: 'javascript-learning-material-06.html' },
        { number: 7, title: '第7章: 処理をまとめよう（関数の基礎）', file: 'javascript-learning-material-07.html' },
        { number: 8, title: '第8章: 複数のデータを扱おう（配列とオブジェクト）', file: 'javascript-learning-material-08.html' },
        { number: 9, title: '第9章: Webページを動かそう（DOM操作の基礎）', file: 'javascript-learning-material-09.html' },
        { number: 10, title: '第10章: ユーザーの操作に反応しよう（イベント処理）', file: 'javascript-learning-material-10.html' },
        { number: 11, title: '第11章: 時間差で処理しよう（非同期処理入門）', file: 'javascript-learning-material-11.html' },
        { number: 12, title: '第12章: ToDoアプリを作ろう（総合演習）', file: 'javascript-learning-material-12.html' }
    ];
