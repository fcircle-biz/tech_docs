...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Flutterとは何か？', file: 'flutter-learning-material-01.html' },
        { number: 2, title: '第2章: 開発環境の準備', file: 'flutter-learning-material-02.html' },
        { number: 3, title: '第3章: はじめてのFlutterアプリ', file: 'flutter-learning-material-03.html' },
        { number: 4, title: '第4章: Dart言語の基礎（前編）', file: 'flutter-learning-material-04.html' },
        { number: 5, title: '第5章: Dart言語の基礎（後編）', file: 'flutter-learning-material-05.html' },
        { number: 6, title: '第6章: Dart言語の関数とクラス', file: 'flutter-learning-material-06.html' },
        { number: 7, title: '第7章: ウィジェットの基本', file: 'flutter-learning-material-07.html' },
        { number: 8, title: '第8章: レイアウトの基礎', file: 'flutter-learning-material-08.html' },
        { number: 9, title: '第9章: ユーザー入力とボタン', file: 'flutter-learning-material-09.html' },
        { number: 10, title: '第10章: 状態管理の基礎', file: 'flutter-learning-material-10.html' },
        { number: 11, title: '第11章: リスト表示とスクロール', file: 'flutter-learning-material-11.html' },
        { number: 12, title: '第12章: 画面遷移（ナビゲーション）', file: 'flutter-learning-material-12.html' },
        { number: 13, title: '第13章: Material Designの活用', file: 'flutter-learning-material-13.html' },
        { number: 14, title: '第14章: 画像とアセットの扱い', file: 'flutter-learning-material-14.html' },
        { number: 15, title: '第15章: フォームとバリデーション', file: 'flutter-learning-material-15.html' },
        { number: 16, title: '第16章: 非同期処理の基礎', file: 'flutter-learning-material-16.html' },
        { number: 17, title: '第17章: HTTP通信とAPI連携', file: 'flutter-learning-material-17.html' },
        { number: 18, title: '第18章: ローカルデータの保存', file: 'flutter-learning-material-18.html' },
        { number: 19, title: '第19章: パッケージの活用', file: 'flutter-learning-material-19.html' },
        { number: 20, title: '第20章: 総合演習：ToDoアプリの作成', file: 'flutter-learning-material-20.html' }
    ];
