...
|----------|------|----------|
| 第1章 | MVCパターン入門 | 30分 |
| 第2章 | 開発環境の準備と最初のアプリ | 60分 |
| 第3章 | Actionクラスの基礎 | 60分 |
| 第4章 | ActionFormの基礎 | 60分 |
| 第5章 | struts-config.xml設定ファイル | 60分 |
| 第6章 | Strutsタグライブラリ入門 | 90分 |
| 第7章 | フォーム処理とバリデーション | 90分 |
| 第8章 | メッセージ管理とエラーハンドリング | 60分 |
| 第9章 | セッション管理とログイン機能 | 90分 |
| 第10章 | データベース連携 | 90分 |
| 第11章 | 国際化対応（i18n） | 60分 |
| 第12章 | 総合演習 | 120分 |
| **合計** | | **約15時間** |
