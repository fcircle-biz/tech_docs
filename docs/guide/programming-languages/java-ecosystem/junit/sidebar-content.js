...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: テストって何だろう？', file: 'junit-learning-material-01.html' },
        { number: 2, title: '第2章: はじめてのJUnitテスト', file: 'junit-learning-material-02.html' },
        { number: 3, title: '第3章: 期待通りか確かめよう', file: 'junit-learning-material-03.html' },
        { number: 4, title: '第4章: テストを整理整頓しよう', file: 'junit-learning-material-04.html' },
        { number: 5, title: '第5章: テストの準備と後片付け', file: 'junit-learning-material-05.html' },
        { number: 6, title: '第6章: 様々な状況を確かめよう', file: 'junit-learning-material-06.html' },
        { number: 7, title: '第7章: エラーもテストしよう', file: 'junit-learning-material-07.html' },
        { number: 8, title: '第8章: テストをもっと読みやすく', file: 'junit-learning-material-08.html' },
        { number: 9, title: '第9章: 実践！電卓アプリ（前編）', file: 'junit-learning-material-09.html' },
        { number: 10, title: '第10章: 実践！電卓アプリ（後編）', file: 'junit-learning-material-10.html' },
        { number: 11, title: '第11章: テスト駆動開発入門', file: 'junit-learning-material-11.html' },
        { number: 12, title: '第12章: 良いテストを書くコツ', file: 'junit-learning-material-12.html' }
    ];
