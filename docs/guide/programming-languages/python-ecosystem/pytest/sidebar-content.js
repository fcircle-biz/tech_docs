...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: テストとは何か - なぜテストを書くのか', file: 'pytest-learning-material-01.html' },
        { number: 2, title: '第2章: pytestの導入と最初のテスト', file: 'pytest-learning-material-02.html' },
        { number: 3, title: '第3章: unittest入門と比較', file: 'pytest-learning-material-03.html' },
        { number: 4, title: '第4章: アサーションの詳細', file: 'pytest-learning-material-04.html' },
        { number: 5, title: '第5章: テストの構造化', file: 'pytest-learning-material-05.html' },
        { number: 6, title: '第6章: フィクスチャ基礎', file: 'pytest-learning-material-06.html' },
        { number: 7, title: '第7章: フィクスチャ応用', file: 'pytest-learning-material-07.html' },
        { number: 8, title: '第8章: パラメータ化テスト', file: 'pytest-learning-material-08.html' },
        { number: 9, title: '第9章: マーカーとテストの選択実行', file: 'pytest-learning-material-09.html' },
        { number: 10, title: '第10章: モックとパッチ', file: 'pytest-learning-material-10.html' },
        { number: 11, title: '第11章: プラグインの活用', file: 'pytest-learning-material-11.html' },
        { number: 12, title: '第12章: テストカバレッジ', file: 'pytest-learning-material-12.html' },
        { number: 13, title: '第13章: 設定ファイルとカスタマイズ', file: 'pytest-learning-material-13.html' },
        { number: 14, title: '第14章: 実践パターン', file: 'pytest-learning-material-14.html' },
        { number: 15, title: '第15章: CI/CDとの連携', file: 'pytest-learning-material-15.html' },
        { number: 16, title: '第16章: 総合演習', file: 'pytest-learning-material-16.html' }
    ];
