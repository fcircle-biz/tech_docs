...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: FastAPI入門とセットアップ', file: 'fastapi-learning-material-01.html' },
        { number: 2, title: '第2章: 基本的なルーティングとHTTPメソッド', file: 'fastapi-learning-material-02.html' },
        { number: 3, title: '第3章: リクエストとレスポンスモデル', file: 'fastapi-learning-material-03.html' },
        { number: 4, title: '第4章: パラメータと検証', file: 'fastapi-learning-material-04.html' },
        { number: 5, title: '第5章: データベースの統合', file: 'fastapi-learning-material-05.html' },
        { number: 6, title: '第6章: 認証とセキュリティ', file: 'fastapi-learning-material-06.html' },
        { number: 7, title: '第7章: CORSとミドルウェア', file: 'fastapi-learning-material-07.html' },
        { number: 8, title: '第8章: 非同期処理とバックグラウンドタスク', file: 'fastapi-learning-material-08.html' },
        { number: 9, title: '第9章: テストとドキュメント', file: 'fastapi-learning-material-09.html' },
        { number: 10, title: '第10章: デプロイと運用', file: 'fastapi-learning-material-10.html' }
    ];
