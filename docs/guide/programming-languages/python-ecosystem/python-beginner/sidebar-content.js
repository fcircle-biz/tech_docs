...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Pythonとは？', file: 'python-beginner-learning-material-01.html' },
        { number: 2, title: '第2章: 環境構築', file: 'python-beginner-learning-material-02.html' },
        { number: 3, title: '第3章: 変数とデータ型', file: 'python-beginner-learning-material-03.html' },
        { number: 4, title: '第4章: 演算と文字列操作', file: 'python-beginner-learning-material-04.html' },
        { number: 5, title: '第5章: 条件分岐', file: 'python-beginner-learning-material-05.html' },
        { number: 6, title: '第6章: 繰り返し処理', file: 'python-beginner-learning-material-06.html' },
        { number: 7, title: '第7章: リストとタプル', file: 'python-beginner-learning-material-07.html' },
        { number: 8, title: '第8章: 辞書', file: 'python-beginner-learning-material-08.html' },
        { number: 9, title: '第9章: 関数の基本', file: 'python-beginner-learning-material-09.html' },
        { number: 10, title: '第10章: ファイルの読み書き', file: 'python-beginner-learning-material-10.html' },
        { number: 11, title: '第11章: エラーへの対処法', file: 'python-beginner-learning-material-11.html' },
        { number: 12, title: '第12章: 実践プログラム作成', file: 'python-beginner-learning-material-12.html' }
    ];
