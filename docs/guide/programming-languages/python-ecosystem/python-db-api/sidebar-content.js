...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Python DB-APIとは', file: 'python-db-api-learning-material-01.html' },
        { number: 2, title: '第2章: 環境構築', file: 'python-db-api-learning-material-02.html' },
        { number: 3, title: '第3章: データベースへの接続', file: 'python-db-api-learning-material-03.html' },
        { number: 4, title: '第4章: データの取得（SELECT）', file: 'python-db-api-learning-material-04.html' },
        { number: 5, title: '第5章: データの追加・更新・削除', file: 'python-db-api-learning-material-05.html' },
        { number: 6, title: '第6章: パラメータ化クエリ', file: 'python-db-api-learning-material-06.html' },
        { number: 7, title: '第7章: トランザクション管理', file: 'python-db-api-learning-material-07.html' },
        { number: 8, title: '第8章: コンテキストマネージャー', file: 'python-db-api-learning-material-08.html' },
        { number: 9, title: '第9章: エラーハンドリング', file: 'python-db-api-learning-material-09.html' },
        { number: 10, title: '第10章: 実践的なデータ操作', file: 'python-db-api-learning-material-10.html' },
        { number: 11, title: '第11章: 接続プール', file: 'python-db-api-learning-material-11.html' },
        { number: 12, title: '第12章: 総合演習', file: 'python-db-api-learning-material-12.html' }
    ];
