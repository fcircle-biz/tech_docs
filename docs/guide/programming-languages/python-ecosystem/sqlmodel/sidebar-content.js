...
(function() {
    ...
    // ========================================
    // 章の定義データ（SQLModel 全10章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: データベースとORMの基礎概念', file: 'sqlmodel-learning-material-01.html' },
        { number: 2, title: '第2章: 環境構築と最初のプログラム', file: 'sqlmodel-learning-material-02.html' },
        { number: 3, title: '第3章: モデルの基本 - データの型を定義する', file: 'sqlmodel-learning-material-03.html' },
        { number: 4, title: '第4章: データの保存と取得（CRUD操作の基本）', file: 'sqlmodel-learning-material-04.html' },
        { number: 5, title: '第5章: データの検索と絞り込み', file: 'sqlmodel-learning-material-05.html' },
        { number: 6, title: '第6章: 複数のテーブルを関連付ける（リレーション入門）', file: 'sqlmodel-learning-material-06.html' },
        { number: 7, title: '第7章: FastAPIで簡単なWeb APIを作る', file: 'sqlmodel-learning-material-07.html' },
        { number: 8, title: '第8章: 実践！TODOアプリケーションの開発', file: 'sqlmodel-learning-material-08.html' },
        { number: 9, title: '第9章: エラー処理とバリデーション', file: 'sqlmodel-learning-material-09.html' },
        { number: 10, title: '第10章: パフォーマンスの基礎知識', file: 'sqlmodel-learning-material-10.html' }
    ];
