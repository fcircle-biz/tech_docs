...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: R言語とは何か', file: 'r-language-beginner-learning-material-01.html' },
        { number: 2, title: '第2章: RStudioのインストールと使い方', file: 'r-language-beginner-learning-material-02.html' },
        { number: 3, title: '第3章: はじめてのR - 計算機として使ってみよう', file: 'r-language-beginner-learning-material-03.html' },
        { number: 4, title: '第4章: データの種類を学ぼう', file: 'r-language-beginner-learning-material-04.html' },
        { number: 5, title: '第5章: 変数とオブジェクト', file: 'r-language-beginner-learning-material-05.html' },
        { number: 6, title: '第6章: ベクトル入門', file: 'r-language-beginner-learning-material-06.html' },
        { number: 7, title: '第7章: データフレーム入門', file: 'r-language-beginner-learning-material-07.html' },
        { number: 8, title: '第8章: 条件分岐', file: 'r-language-beginner-learning-material-08.html' },
        { number: 9, title: '第9章: 繰り返し処理', file: 'r-language-beginner-learning-material-09.html' },
        { number: 10, title: '第10章: 関数の使い方', file: 'r-language-beginner-learning-material-10.html' },
        { number: 11, title: '第11章: グラフ作成入門', file: 'r-language-beginner-learning-material-11.html' },
        { number: 12, title: '第12章: ファイルの読み書き', file: 'r-language-beginner-learning-material-12.html' }
    ];
