...
(function() {
    ...
    // ========================================
    // 章の定義データ（PHP入門ガイド全14章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: PHPとプログラミングの基礎', file: 'php-learning-material-01.html' },
        { number: 2, title: '第2章: 開発環境の構築', file: 'php-learning-material-02.html' },
        { number: 3, title: '第3章: 変数とデータ型', file: 'php-learning-material-03.html' },
        { number: 4, title: '第4章: 条件分岐と繰り返し', file: 'php-learning-material-04.html' },
        { number: 5, title: '第5章: 関数の基礎', file: 'php-learning-material-05.html' },
        { number: 6, title: '第6章: 配列の操作', file: 'php-learning-material-06.html' },
        { number: 7, title: '第7章: フォーム処理とHTTP通信', file: 'php-learning-material-07.html' },
        { number: 8, title: '第8章: ファイル操作', file: 'php-learning-material-08.html' },
        { number: 9, title: '第9章: セッション管理とCookie', file: 'php-learning-material-09.html' },
        { number: 10, title: '第10章: データベース連携の基礎', file: 'php-learning-material-10.html' },
        { number: 11, title: '第11章: エラー処理とデバッグ', file: 'php-learning-material-11.html' },
        { number: 12, title: '第12章: オブジェクト指向プログラミング入門', file: 'php-learning-material-12.html' },
        { number: 13, title: '第13章: セキュリティの基礎', file: 'php-learning-material-13.html' },
        { number: 14, title: '第14章: 実践的なWebアプリケーション作成', file: 'php-learning-material-14.html' }
    ];
