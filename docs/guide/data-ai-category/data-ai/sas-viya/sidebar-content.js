...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: SAS Viyaの概要とアーキテクチャ', file: 'sas-viya-learning-material-01.html' },
        { number: 2, title: '第2章: SAS Viya環境のセットアップと基本操作', file: 'sas-viya-learning-material-02.html' },
        { number: 3, title: '第3章: CAS（Cloud Analytic Services）の基礎', file: 'sas-viya-learning-material-03.html' },
        { number: 4, title: '第4章: SAS Studioでのプログラミング（Viya版）', file: 'sas-viya-learning-material-04.html' },
        { number: 5, title: '第5章: データの準備と管理', file: 'sas-viya-learning-material-05.html' },
        { number: 6, title: '第6章: SAS Visual Analyticsによるデータ可視化（基礎）', file: 'sas-viya-learning-material-06.html' },
        { number: 7, title: '第7章: SAS Visual Analyticsによるデータ可視化（応用）', file: 'sas-viya-learning-material-07.html' },
        { number: 8, title: '第8章: SAS Model Studioによる機械学習（基礎）', file: 'sas-viya-learning-material-08.html' },
        { number: 9, title: '第9章: SAS Model Studioによる機械学習（応用）', file: 'sas-viya-learning-material-09.html' },
        { number: 10, title: '第10章: 予測モデリングと時系列分析', file: 'sas-viya-learning-material-10.html' },
        { number: 11, title: '第11章: テキストアナリティクスと自然言語処理', file: 'sas-viya-learning-material-11.html' },
        { number: 12, title: '第12章: モデルの展開と運用（MLOps）', file: 'sas-viya-learning-material-12.html' },
        { number: 13, title: '第13章: Python/Rとの連携', file: 'sas-viya-learning-material-13.html' },
        { number: 14, title: '第14章: API活用と自動化', file: 'sas-viya-learning-material-14.html' },
        { number: 15, title: '第15章: 実践プロジェクト：顧客分析ダッシュボード構築', file: 'sas-viya-learning-material-15.html' }
    ];
