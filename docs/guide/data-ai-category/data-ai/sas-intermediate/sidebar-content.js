...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: DATAステップの高度な制御', file: 'sas-intermediate-learning-material-01.html' },
        { number: 2, title: '第2章: 配列と反復処理の応用', file: 'sas-intermediate-learning-material-02.html' },
        { number: 3, title: '第3章: ハッシュオブジェクト', file: 'sas-intermediate-learning-material-03.html' },
        { number: 4, title: '第4章: 高度なPROC SQL', file: 'sas-intermediate-learning-material-04.html' },
        { number: 5, title: '第5章: SASマクロ：自動化と動的生成', file: 'sas-intermediate-learning-material-05.html' },
        { number: 6, title: '第6章: カスタムフォーマットとラベル', file: 'sas-intermediate-learning-material-06.html' },
        { number: 7, title: '第7章: ODS プログラミング', file: 'sas-intermediate-learning-material-07.html' },
        { number: 8, title: '第8章: 統計解析の実践：推測統計', file: 'sas-intermediate-learning-material-08.html' },
        { number: 9, title: '第9章: 統計解析の実践：モデル構築', file: 'sas-intermediate-learning-material-09.html' },
        { number: 10, title: '第10章: パフォーマンス・チューニングとベストプラクティス', file: 'sas-intermediate-learning-material-10.html' }
    ];
