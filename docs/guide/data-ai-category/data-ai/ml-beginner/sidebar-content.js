...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '機械学習って何だろう？', file: 'ml-beginner-learning-material-01.html' },
        { number: 2, title: 'データの見方を学ぼう', file: 'ml-beginner-learning-material-02.html' },
        { number: 3, title: 'AIに「予測」させてみよう', file: 'ml-beginner-learning-material-03.html' },
        { number: 4, title: 'AIに「分類」させてみよう', file: 'ml-beginner-learning-material-04.html' },
        { number: 5, title: 'AIに「グループ分け」させてみよう', file: 'ml-beginner-learning-material-05.html' },
        { number: 6, title: 'ノーコードでAIを体験しよう', file: 'ml-beginner-learning-material-06.html' },
        { number: 7, title: '良いデータと悪いデータ', file: 'ml-beginner-learning-material-07.html' },
        { number: 8, title: 'AIの予測は正しいの？', file: 'ml-beginner-learning-material-08.html' },
        { number: 9, title: 'ビジネスでの活用事例', file: 'ml-beginner-learning-material-09.html' },
        { number: 10, title: 'AIプロジェクトの進め方', file: 'ml-beginner-learning-material-10.html' },
        { number: 11, title: 'AIの限界と注意点', file: 'ml-beginner-learning-material-11.html' },
        { number: 12, title: '次のステップへ', file: 'ml-beginner-learning-material-12.html' }
    ];
