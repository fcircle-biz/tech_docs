...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: 統計学とは何か', file: 'statistical-analysis-learning-material-01.html' },
        { number: 2, title: '第2章: データの種類と収集方法', file: 'statistical-analysis-learning-material-02.html' },
        { number: 3, title: '第3章: 記述統計の基礎', file: 'statistical-analysis-learning-material-03.html' },
        { number: 4, title: '第4章: データの可視化', file: 'statistical-analysis-learning-material-04.html' },
        { number: 5, title: '第5章: 確率の基礎', file: 'statistical-analysis-learning-material-05.html' },
        { number: 6, title: '第6章: 確率分布と正規分布', file: 'statistical-analysis-learning-material-06.html' },
        { number: 7, title: '第7章: 推測統計入門', file: 'statistical-analysis-learning-material-07.html' },
        { number: 8, title: '第8章: 仮説検定の基礎', file: 'statistical-analysis-learning-material-08.html' },
        { number: 9, title: '第9章: 実践的な検定手法', file: 'statistical-analysis-learning-material-09.html' },
        { number: 10, title: '第10章: ビジネスでの統計活用', file: 'statistical-analysis-learning-material-10.html' }
    ];
