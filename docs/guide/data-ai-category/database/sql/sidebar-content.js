...
(function() {
    ...
    // ========================================
    // 章の定義データ（SQL入門ガイド 全12章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: データベースってなに？', file: 'sql-learning-material-01.html' },
        { number: 2, title: '第2章: PostgreSQLをインストールしてみよう', file: 'sql-learning-material-02.html' },
        { number: 3, title: '第3章: はじめてのテーブル作成', file: 'sql-learning-material-03.html' },
        { number: 4, title: '第4章: データを入れてみよう（INSERT文）', file: 'sql-learning-material-04.html' },
        { number: 5, title: '第5章: データを見てみよう（SELECT文の基礎）', file: 'sql-learning-material-05.html' },
        { number: 6, title: '第6章: データを変更・削除してみよう', file: 'sql-learning-material-06.html' },
        { number: 7, title: '第7章: 条件を付けてデータを探そう', file: 'sql-learning-material-07.html' },
        { number: 8, title: '第8章: データを並び替えて見やすくしよう', file: 'sql-learning-material-08.html' },
        { number: 9, title: '第9章: 複数のテーブルを組み合わせよう', file: 'sql-learning-material-09.html' },
        { number: 10, title: '第10章: データをまとめて集計しよう', file: 'sql-learning-material-10.html' },
        { number: 11, title: '第11章: より複雑な検索をしてみよう', file: 'sql-learning-material-11.html' },
        { number: 12, title: '第12章: 実践！簡単な管理システムを作ろう', file: 'sql-learning-material-12.html' }
    ];
