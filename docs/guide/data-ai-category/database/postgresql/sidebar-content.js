...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: PostgreSQLとは', file: 'postgresql-learning-material-01.html' },
        { number: 2, title: '第2章: PostgreSQLの環境構築', file: 'postgresql-learning-material-02.html' },
        { number: 3, title: '第3章: PostgreSQLのデータ型', file: 'postgresql-learning-material-03.html' },
        { number: 4, title: '第4章: PostgreSQLのテーブル設計', file: 'postgresql-learning-material-04.html' },
        { number: 5, title: '第5章: PostgreSQLの便利な関数', file: 'postgresql-learning-material-05.html' },
        { number: 6, title: '第6章: JSONデータの操作', file: 'postgresql-learning-material-06.html' },
        { number: 7, title: '第7章: ビューとマテリアライズドビュー', file: 'postgresql-learning-material-07.html' },
        { number: 8, title: '第8章: トランザクションとロック', file: 'postgresql-learning-material-08.html' },
        { number: 9, title: '第9章: PostgreSQLのインデックス詳解', file: 'postgresql-learning-material-09.html' },
        { number: 10, title: '第10章: バックアップとリストア', file: 'postgresql-learning-material-10.html' },
        { number: 11, title: '第11章: ユーザーと権限管理', file: 'postgresql-learning-material-11.html' },
        { number: 12, title: '第12章: 実践！PostgreSQLでWebアプリのDBを設計しよう', file: 'postgresql-learning-material-12.html' }
    ];
