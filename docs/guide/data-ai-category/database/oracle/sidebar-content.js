...
(function() {
    ...
    const chapters = [
        ...
        { number: 7, title: '第7章: Oracle SQL実践（結合・サブクエリ）', file: 'oracle-learning-material-07.html' },
        { number: 8, title: '第8章: PL/SQL入門', file: 'oracle-learning-material-08.html' },
        { number: 9, title: '第9章: トランザクション管理とバックアップ基礎', file: 'oracle-learning-material-09.html' },
        { number: 10, title: '第10章: パフォーマンス基礎とインデックス', file: 'oracle-learning-material-10.html' }
    ];
