...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: PL/SQLってなに？', file: 'plsql-learning-material-01.html' },
        { number: 2, title: '第2章: はじめてのPL/SQLプログラム', file: 'plsql-learning-material-02.html' },
        { number: 3, title: '第3章: 変数を使ってデータを覚えよう', file: 'plsql-learning-material-03.html' },
        { number: 4, title: '第4章: データベースからデータを取り出そう', file: 'plsql-learning-material-04.html' },
        { number: 5, title: '第5章: 条件によって処理を変えよう', file: 'plsql-learning-material-05.html' },
        { number: 6, title: '第6章: 同じ処理を繰り返そう', file: 'plsql-learning-material-06.html' },
        { number: 7, title: '第7章: 複数のデータをまとめて処理', file: 'plsql-learning-material-07.html' },
        { number: 8, title: '第8章: エラーに備えよう', file: 'plsql-learning-material-08.html' },
        { number: 9, title: '第9章: 処理をまとめて部品化', file: 'plsql-learning-material-09.html' },
        { number: 10, title: '第10章: データベースの変更を自動化', file: 'plsql-learning-material-10.html' },
        { number: 11, title: '第11章: 複数の処理をパッケージ化', file: 'plsql-learning-material-11.html' },
        { number: 12, title: '第12章: 実践！簡単な業務システムを作ろう', file: 'plsql-learning-material-12.html' }
    ];
