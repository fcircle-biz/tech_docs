...
(function() {
    ...
    // ========================================
    // 章の定義データ（MySQL入門 全12章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: MySQLとは - 世界で最も使われるオープンソースDBを知ろう', file: 'mysql-learning-material-01.html' },
        { number: 2, title: '第2章: MySQLの環境構築 - インストールとMySQL Workbenchの使い方', file: 'mysql-learning-material-02.html' },
        { number: 3, title: '第3章: MySQLのデータ型 - 適切な型選びでパフォーマンスを最適化', file: 'mysql-learning-material-03.html' },
        { number: 4, title: '第4章: MySQLのテーブル設計 - 制約とストレージエンジンの基礎', file: 'mysql-learning-material-04.html' },
        { number: 5, title: '第5章: MySQLの便利な関数 - 文字列・日付・数値の操作', file: 'mysql-learning-material-05.html' },
        { number: 6, title: '第6章: MySQLのインデックス - クエリを高速化する仕組み', file: 'mysql-learning-material-06.html' },
        { number: 7, title: '第7章: トランザクションとロック - データの整合性を守る', file: 'mysql-learning-material-07.html' },
        { number: 8, title: '第8章: ビューとストアドプロシージャ - 再利用可能なSQLを作る', file: 'mysql-learning-material-08.html' },
        { number: 9, title: '第9章: MySQLの文字コードと照合順序 - 日本語を正しく扱う', file: 'mysql-learning-material-09.html' },
        { number: 10, title: '第10章: バックアップとリストア - データを安全に守る', file: 'mysql-learning-material-10.html' },
        { number: 11, title: '第11章: ユーザーと権限管理 - セキュリティの基礎', file: 'mysql-learning-material-11.html' },
        { number: 12, title: '第12章: 実践！MySQLでWebアプリのDBを設計しよう', file: 'mysql-learning-material-12.html' }
    ];
