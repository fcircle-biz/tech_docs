...
(function() {
    ...
    // ========================================
    // 章の定義データ（Tailwind CSS学習ガイド）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Tailwind CSSとは', file: 'tailwind-css-learning-material-01.html' },
        { number: 2, title: '第2章: 基本的なスタイリング', file: 'tailwind-css-learning-material-02.html' },
        { number: 3, title: '第3章: スペーシングとサイジング', file: 'tailwind-css-learning-material-03.html' },
        { number: 4, title: '第4章: ボーダーと装飾', file: 'tailwind-css-learning-material-04.html' },
        { number: 5, title: '第5章: Flexboxレイアウト', file: 'tailwind-css-learning-material-05.html' },
        { number: 6, title: '第6章: Gridレイアウト', file: 'tailwind-css-learning-material-06.html' },
        { number: 7, title: '第7章: レスポンシブデザイン', file: 'tailwind-css-learning-material-07.html' },
        { number: 8, title: '第8章: ホバーとフォーカス', file: 'tailwind-css-learning-material-08.html' },
        { number: 9, title: '第9章: コンポーネントの作成', file: 'tailwind-css-learning-material-09.html' },
        { number: 10, title: '第10章: 実践プロジェクト', file: 'tailwind-css-learning-material-10.html' }
    ];
