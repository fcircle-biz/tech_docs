...
(function() {
    ...
    // 章の定義データ
    const chapters = [
        { number: 1, title: '第1章: インターネットとWebの仕組み', file: 'webapp-intro-learning-material-01.html' },
        { number: 2, title: '第2章: ネットワークの基礎知識', file: 'webapp-intro-learning-material-02.html' },
        { number: 3, title: '第3章: URLの構造を理解しよう', file: 'webapp-intro-learning-material-03.html' },
        { number: 4, title: '第4章: クライアントとサーバー', file: 'webapp-intro-learning-material-04.html' },
        { number: 5, title: '第5章: HTTPプロトコルの基本', file: 'webapp-intro-learning-material-05.html' },
        { number: 6, title: '第6章: HTTPメソッドを理解しよう', file: 'webapp-intro-learning-material-06.html' },
        { number: 7, title: '第7章: データ形式（JSON）', file: 'webapp-intro-learning-material-07.html' },
        { number: 8, title: '第8章: REST APIの基本', file: 'webapp-intro-learning-material-08.html' },
        { number: 9, title: '第9章: データベースの役割', file: 'webapp-intro-learning-material-09.html' },
        { number: 10, title: '第10章: Webアプリの3層構造', file: 'webapp-intro-learning-material-10.html' },
        { number: 11, title: '第11章: ローカル開発環境', file: 'webapp-intro-learning-material-11.html' },
        { number: 12, title: '第12章: CORSとセキュリティ基礎', file: 'webapp-intro-learning-material-12.html' },
        { number: 13, title: '第13章: 開発者ツールでWebを観察しよう', file: 'webapp-intro-learning-material-13.html' },
        { number: 14, title: '第14章: Webアプリ開発の全体像', file: 'webapp-intro-learning-material-14.html' }
    ];
