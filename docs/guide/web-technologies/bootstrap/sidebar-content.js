...
(function() {
    ...
    // ========================================
    // Bootstrap入門ガイド - 章の定義データ
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Bootstrapとは？', file: 'bootstrap-learning-material-01.html' },
        { number: 2, title: '第2章: 導入と基本テンプレート', file: 'bootstrap-learning-material-02.html' },
        { number: 3, title: '第3章: コンテナとグリッドシステム入門', file: 'bootstrap-learning-material-03.html' },
        { number: 4, title: '第4章: レスポンシブグリッドの実践', file: 'bootstrap-learning-material-04.html' },
        { number: 5, title: '第5章: テキストとタイポグラフィ', file: 'bootstrap-learning-material-05.html' },
        { number: 6, title: '第6章: 色とスペーシング', file: 'bootstrap-learning-material-06.html' },
        { number: 7, title: '第7章: ボタンとフォーム', file: 'bootstrap-learning-material-07.html' },
        { number: 8, title: '第8章: カードとリストグループ', file: 'bootstrap-learning-material-08.html' },
        { number: 9, title: '第9章: ナビゲーションバー', file: 'bootstrap-learning-material-09.html' },
        { number: 10, title: '第10章: モーダルとアラート', file: 'bootstrap-learning-material-10.html' },
        { number: 11, title: '第11章: カルーセルと画像ギャラリー', file: 'bootstrap-learning-material-11.html' },
        { number: 12, title: '第12章: テーブルとデータ表示', file: 'bootstrap-learning-material-12.html' },
        { number: 13, title: '第13章: アイコンと装飾要素', file: 'bootstrap-learning-material-13.html' },
        { number: 14, title: '第14章: カスタマイズとテーマ作成', file: 'bootstrap-learning-material-14.html' },
        { number: 15, title: '第15章: 実践プロジェクト', file: 'bootstrap-learning-material-15.html' }
    ];
