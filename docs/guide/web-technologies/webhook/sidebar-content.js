...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Webhookとは何か？', file: 'webhook-learning-material-01.html' },
        { number: 2, title: '第2章: APIとWebhookの違い', file: 'webhook-learning-material-02.html' },
        { number: 3, title: '第3章: Webhookの仕組み', file: 'webhook-learning-material-03.html' },
        { number: 4, title: '第4章: HTTPの基礎', file: 'webhook-learning-material-04.html' },
        { number: 5, title: '第5章: JSONデータの読み方', file: 'webhook-learning-material-05.html' },
        { number: 6, title: '第6章: Webhookの登録と設定', file: 'webhook-learning-material-06.html' },
        { number: 7, title: '第7章: チャットツール連携', file: 'webhook-learning-material-07.html' },
        { number: 8, title: '第8章: 決済・ECサービス', file: 'webhook-learning-material-08.html' },
        { number: 9, title: '第9章: GitHub・開発ツール連携', file: 'webhook-learning-material-09.html' },
        { number: 10, title: '第10章: セキュリティの基礎', file: 'webhook-learning-material-10.html' },
        { number: 11, title: '第11章: エラーとリトライ', file: 'webhook-learning-material-11.html' },
        { number: 12, title: '第12章: Webhookを体験しよう', file: 'webhook-learning-material-12.html' },
        { number: 13, title: '第13章: ノーコードツール活用', file: 'webhook-learning-material-13.html' },
        { number: 14, title: '第14章: 全体像と次のステップ', file: 'webhook-learning-material-14.html' }
    ];
