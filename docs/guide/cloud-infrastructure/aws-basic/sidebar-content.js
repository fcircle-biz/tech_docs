...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: クラウドって何？AWSを身近な例えで理解しよう', file: 'aws-learning-material-01.html' },
        { number: 2, title: '第2章: AWSに登録しよう - お財布にやさしい設定も一緒に', file: 'aws-learning-material-02.html' },
        { number: 3, title: '第3章: AWSの画面に慣れよう - 管理画面の歩き方', file: 'aws-learning-material-03.html' },
        { number: 4, title: '第4章: 最初のサーバーを作ってみよう - EC2入門', file: 'aws-learning-material-04.html' },
        { number: 5, title: '第5章: ファイルの保管場所を作ろう - S3入門', file: 'aws-learning-material-05.html' },
        { number: 6, title: '第6章: インターネットの通り道を作ろう - ネットワーク入門', file: 'aws-learning-material-06.html' },
        { number: 7, title: '第7章: データベースを使ってみよう - RDS入門', file: 'aws-learning-material-07.html' },
        { number: 8, title: '第8章: アクセス権限を管理しよう - IAM入門', file: 'aws-learning-material-08.html' },
        { number: 9, title: '第9章: サーバーの状態を見守ろう - CloudWatch入門', file: 'aws-learning-material-09.html' },
        { number: 10, title: '第10章: サーバーなしでプログラムを動かそう - Lambda入門', file: 'aws-learning-material-10.html' },
        { number: 11, title: '第11章: 学んだことをまとめよう - 復習と実践プロジェクト', file: 'aws-learning-material-11.html' },
        { number: 12, title: '第12章: 次のステップ - これからの学習ガイド', file: 'aws-learning-material-12.html' }
    ];
