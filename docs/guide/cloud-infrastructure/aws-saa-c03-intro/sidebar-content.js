...
(function() {
    ...
    // ========================================
    // 章の定義データ（AWS SAA-C03入門ガイド）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: 試験概要と設計思考', file: 'aws-saa-c03-intro-learning-material-01.html' },
        { number: 2, title: '第2章: Well-Architectedフレームワーク', file: 'aws-saa-c03-intro-learning-material-02.html' },
        { number: 3, title: '第3章: 高可用性とスケーラビリティの基礎', file: 'aws-saa-c03-intro-learning-material-03.html' },
        { number: 4, title: '第4章: Elastic Load Balancing', file: 'aws-saa-c03-intro-learning-material-04.html' },
        { number: 5, title: '第5章: EC2 Auto Scaling', file: 'aws-saa-c03-intro-learning-material-05.html' },
        { number: 6, title: '第6章: Route 53', file: 'aws-saa-c03-intro-learning-material-06.html' },
        { number: 7, title: '第7章: VPC設計', file: 'aws-saa-c03-intro-learning-material-07.html' },
        { number: 8, title: '第8章: データベースサービスの選択と設計', file: 'aws-saa-c03-intro-learning-material-08.html' },
        { number: 9, title: '第9章: ストレージサービスの設計', file: 'aws-saa-c03-intro-learning-material-09.html' },
        { number: 10, title: '第10章: セキュリティとアイデンティティ', file: 'aws-saa-c03-intro-learning-material-10.html' },
        { number: 11, title: '第11章: サーバーレスとアプリケーション統合', file: 'aws-saa-c03-intro-learning-material-11.html' },
        { number: 12, title: '第12章: 総合演習', file: 'aws-saa-c03-intro-learning-material-12.html' }
    ];
