...
(function() {
    ...
    // ========================================
    // 章の定義データ（クラウドコンピューティング入門）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: クラウドコンピューティングとは', file: 'cloud-computing-learning-material-01.html' },
        { number: 2, title: '第2章: クラウドサービスの3つの種類', file: 'cloud-computing-learning-material-02.html' },
        { number: 3, title: '第3章: クラウドの導入形態', file: 'cloud-computing-learning-material-03.html' },
        { number: 4, title: '第4章: 主要クラウドプロバイダーの比較', file: 'cloud-computing-learning-material-04.html' },
        { number: 5, title: '第5章: クラウドの基本構成要素', file: 'cloud-computing-learning-material-05.html' },
        { number: 6, title: '第6章: クラウドセキュリティの基礎', file: 'cloud-computing-learning-material-06.html' },
        { number: 7, title: '第7章: クラウドコスト管理入門', file: 'cloud-computing-learning-material-07.html' },
        { number: 8, title: '第8章: クラウドを始めよう', file: 'cloud-computing-learning-material-08.html' }
    ];
