...
(function() {
    ...
    // ========================================
    // 章の定義データ（AWS DVA-C02入門）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Developer Associate資格への道', file: 'aws-dva-c02-intro-learning-material-01.html' },
        { number: 2, title: '第2章: サーバーレスコンピューティング基礎', file: 'aws-dva-c02-intro-learning-material-02.html' },
        { number: 3, title: '第3章: Lambda関数の開発とデプロイ', file: 'aws-dva-c02-intro-learning-material-03.html' },
        { number: 4, title: '第4章: Amazon DynamoDB基礎', file: 'aws-dva-c02-intro-learning-material-04.html' },
        { number: 5, title: '第5章: DynamoDB高度な操作', file: 'aws-dva-c02-intro-learning-material-05.html' },
        { number: 6, title: '第6章: Amazon API Gateway', file: 'aws-dva-c02-intro-learning-material-06.html' },
        { number: 7, title: '第7章: API Gatewayセキュリティと認証', file: 'aws-dva-c02-intro-learning-material-07.html' },
        { number: 8, title: '第8章: AWS Step Functions', file: 'aws-dva-c02-intro-learning-material-08.html' },
        { number: 9, title: '第9章: イベント駆動アーキテクチャ', file: 'aws-dva-c02-intro-learning-material-09.html' },
        { number: 10, title: '第10章: アプリケーションセキュリティ', file: 'aws-dva-c02-intro-learning-material-10.html' },
        { number: 11, title: '第11章: 開発者ツールとCI/CD', file: 'aws-dva-c02-intro-learning-material-11.html' },
        { number: 12, title: '第12章: 監視とデバッグ', file: 'aws-dva-c02-intro-learning-material-12.html' }
    ];
