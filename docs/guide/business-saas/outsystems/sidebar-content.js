...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: OutSystemsの世界へようこそ - ローコード開発入門', file: 'outsystems-learning-material-01.html' },
        { number: 2, title: '第2章: 画面を作ろう - スクリーンとウィジェット', file: 'outsystems-learning-material-02.html' },
        { number: 3, title: '第3章: データを管理する - エンティティとアトリビュート', file: 'outsystems-learning-material-03.html' },
        { number: 4, title: '第4章: データを表示する - アグリゲートとリスト', file: 'outsystems-learning-material-04.html' },
        { number: 5, title: '第5章: ユーザーの入力を受け取る - フォームとアクション', file: 'outsystems-learning-material-05.html' },
        { number: 6, title: '第6章: 処理の流れを制御する - 条件分岐とループ', file: 'outsystems-learning-material-06.html' },
        { number: 7, title: '第7章: 画面をつなげる - ナビゲーションとパラメータ', file: 'outsystems-learning-material-07.html' },
        { number: 8, title: '第8章: データを検証する - バリデーションとエラー処理', file: 'outsystems-learning-material-08.html' },
        { number: 9, title: '第9章: データの関係を理解する - リレーションシップ', file: 'outsystems-learning-material-09.html' },
        { number: 10, title: '第10章: 見た目を整える - CSSとテーマ', file: 'outsystems-learning-material-10.html' },
        { number: 11, title: '第11章: 外部と連携する - REST APIとIntegration', file: 'outsystems-learning-material-11.html' },
        { number: 12, title: '第12章: セキュリティを確保する - ユーザー管理とアクセス制御', file: 'outsystems-learning-material-12.html' },
        { number: 13, title: '第13章: アプリを公開する - デプロイメントと環境管理', file: 'outsystems-learning-material-13.html' },
        { number: 14, title: '第14章: パフォーマンスを改善する - 最適化とトラブルシューティング', file: 'outsystems-learning-material-14.html' }
    ];
