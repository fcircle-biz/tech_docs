...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: VBAとは？プログラミングの第一歩', file: 'vba-learning-material-01.html' },
        { number: 2, title: '第2章: VBA開発環境の基本操作', file: 'vba-learning-material-02.html' },
        { number: 3, title: '第3章: 変数とデータ型の基礎', file: 'vba-learning-material-03.html' },
        { number: 4, title: '第4章: セルとワークシートの操作', file: 'vba-learning-material-04.html' },
        { number: 5, title: '第5章: 条件分岐（If文）で賢い処理を作る', file: 'vba-learning-material-05.html' },
        { number: 6, title: '第6章: 繰り返し処理（ループ）で効率化', file: 'vba-learning-material-06.html' },
        { number: 7, title: '第7章: 配列とコレクションでデータを管理', file: 'vba-learning-material-07.html' },
        { number: 8, title: '第8章: プロシージャ（Sub/Function）で再利用可能なコードを作る', file: 'vba-learning-material-08.html' },
        { number: 9, title: '第9章: エラー処理で安全なプログラムを作る', file: 'vba-learning-material-09.html' },
        { number: 10, title: '第10章: ユーザーフォームで対話型ツールを作る', file: 'vba-learning-material-10.html' },
        { number: 11, title: '第11章: ファイル操作と外部データ連携', file: 'vba-learning-material-11.html' },
        { number: 12, title: '第12章: 実践！業務自動化ツールを作る', file: 'vba-learning-material-12.html' }
    ];
