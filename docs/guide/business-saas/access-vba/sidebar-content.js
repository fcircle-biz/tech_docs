...
(function() {
    ...
    // ========================================
    // 章の定義データ（Access VBA全12章）
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Access VBAとは？', file: 'access-vba-learning-material-01.html' },
        { number: 2, title: '第2章: Accessデータベースの基礎知識', file: 'access-vba-learning-material-02.html' },
        { number: 3, title: '第3章: VBA開発環境とはじめてのプログラム', file: 'access-vba-learning-material-03.html' },
        { number: 4, title: '第4章: 変数とデータ型の基礎', file: 'access-vba-learning-material-04.html' },
        { number: 5, title: '第5章: 条件分岐と繰り返し処理', file: 'access-vba-learning-material-05.html' },
        { number: 6, title: '第6章: DoCmdオブジェクトによるAccess操作', file: 'access-vba-learning-material-06.html' },
        { number: 7, title: '第7章: DAO/ADOによるデータベース操作', file: 'access-vba-learning-material-07.html' },
        { number: 8, title: '第8章: SQLとVBAの連携', file: 'access-vba-learning-material-08.html' },
        { number: 9, title: '第9章: フォームとイベント処理', file: 'access-vba-learning-material-09.html' },
        { number: 10, title: '第10章: レポートの自動生成とカスタマイズ', file: 'access-vba-learning-material-10.html' },
        { number: 11, title: '第11章: エラー処理とデバッグ技法', file: 'access-vba-learning-material-11.html' },
        { number: 12, title: '第12章: 実践！業務データベースシステムの構築', file: 'access-vba-learning-material-12.html' }
    ];
