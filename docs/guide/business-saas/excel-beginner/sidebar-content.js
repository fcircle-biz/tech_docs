...
(function() {
    ...
    // ========================================
    const chapters = [
        { number: 1, title: '第1章: Excelを始めよう', file: 'excel-beginner-learning-material-01.html' },
        { number: 2, title: '第2章: セルに文字や数字を入力しよう', file: 'excel-beginner-learning-material-02.html' },
        { number: 3, title: '第3章: ファイルを保存しよう', file: 'excel-beginner-learning-material-03.html' },
        { number: 4, title: '第4章: かんたんな表を作ってみよう', file: 'excel-beginner-learning-material-04.html' },
        { number: 5, title: '第5章: 計算をしてみよう', file: 'excel-beginner-learning-material-05.html' },
        { number: 6, title: '第6章: よく使う関数を覚えよう', file: 'excel-beginner-learning-material-06.html' },
        { number: 7, title: '第7章: 表を見やすくしよう', file: 'excel-beginner-learning-material-07.html' },
        { number: 8, title: '第8章: データを並べ替え・絞り込もう', file: 'excel-beginner-learning-material-08.html' },
        { number: 9, title: '第9章: 表を印刷しよう', file: 'excel-beginner-learning-material-09.html' },
        { number: 10, title: '第10章: グラフを作ってみよう', file: 'excel-beginner-learning-material-10.html' },
        { number: 11, title: '第11章: 実践！業務で使える表を作ろう', file: 'excel-beginner-learning-material-11.html' }
    ];
