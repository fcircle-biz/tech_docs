...
```
/assignment-creator [仕様書フォルダパス] [--step N]
```
...
例:
- `/assignment-creator specs/order-management-v1/docs`
- `/assignment-creator specs/inventory-system-v1/docs`
- `/assignment-creator specs/order-management-v1/docs --step 5`（Step5のみ再生成）
...
3. **検証フェーズ**: `content-reviewer` スキル、または `references/step3-step-html.md` のチェックリストで生成物を検証。
