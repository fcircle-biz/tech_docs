...
content-reviewer 本体（メイン会話ループ）が実行する詳細手順。検証観点そのものは references/checklist.md を参照。共通ルールの真実源は CLAUDE.md と `templates/v2/reference/`。
...
指示:
  1. .claude/skills/content-reviewer/references/checklist.md を読む。
