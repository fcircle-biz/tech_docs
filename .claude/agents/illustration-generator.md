...
生成日時: [YYYY-MM-DD]
対象ファイル: [SuggestionsPath]
処理章: [ChapterNumberまたは"全章"]

## 生成されたファイル一覧

| ファイル名 | 章 | セクション | 図解タイプ | HTML挿入済み |
|:---|:---|:---|:---|:---|
| [filename.jpg] | [章番号] | [セクション名] | [タイプ] | ✅ / ❌ |

## 次のステップ

1. 生成されたプレースホルダー画像を確認
2. 各JPG内のプロンプトを画像生成AI（DALL-E、Midjourney等）に入力
3. 生成された画像でプレースホルダーを置き換え
```
